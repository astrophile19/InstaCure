                ...
                for (int i = 0; i < ss.length(); i++) {
                    if (ss.charAt(i) == '_') {
                        if (i + 1 < ss.length()) {
                            ...
                            hs = y.getString(3);
                            hsi = ((int) hs.charAt(0) - (int) '0') ;
                            hsi += ((int) hs.charAt(1) - (int) '0');

                            he = y.getString(4);
                            hei = ((int) he.charAt(0) - (int) '0') ;
                            ...
                            if (ad.length() != 0 && (ad.toString()).equals(specialization) && ((r1 <= hsi && r2 >= hsi) || (r1 <= hei && r2 >= hei))) {
                                ...
                                if (z!=null && z.moveToFirst()) {
                                    name = "Dr. " + z.getString(1) ;
                                    s_doctors.add(name);
                                    u_d.add(z.getString(11));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(Select_Doctor.this, Login.class));
                Message.message(Select_Doctor.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(Select_Doctor.this, Patient.class));
                Message.message(Select_Doctor.this,"MAIN MENU");
                this.finish();
                return true;
            default:
