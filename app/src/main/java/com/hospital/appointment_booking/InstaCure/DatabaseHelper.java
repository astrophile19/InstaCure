...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "HABIC_DATABASE.db";
    ...
    public Cursor checkduplicates_in_user_credentials(String user_name, String password, String table) {
        ...
        switch (table) {
            ...
            case TABLE_NAME_USER:
                ...
                break;
            case TABLE_NAME_DOCTOR_PATIENT:
                if (password == null) return null;
    ...
    boolean insert_user_credentials(String fnames, String lnames, String ages, String dobs, String citys, String pincodes, String unames, String passwords, String mobnos, String utypes, String sexs, String bgroups) {
    ...
    boolean update_user_credentials(String ou, String op, String fnames, String lnames, String ages, String dobs, String citys, String pincodes, String unames, String passwords, String mobnos, String utypes, String sexs, String bgroups) {
    ...
    public boolean delete_bills(String p_username, String p_password,String fees_paid,String problem) {
        SQLiteDatabase db1 = this.getWritableDatabase();
        long l = db1.delete(TABLE_NAME_DOCTOR_PATIENT, "p_username=? and p_password=? and problem=? and fees_paid=?", new String[]{p_username, p_password, problem,fees_paid});
        return l != -1;
    ...
    //********************************************FEEDBACK*******************************
    boolean insert_feedback(String username, String password, String feecback) {
    ...
    public boolean delete_feedback(String ou, String op) {
        SQLiteDatabase db1 = this.getWritableDatabase();
        long l = db1.delete(TABLE_NAME_FEEDBACK, "username=? and password=?", new String[]{ou, op});
   ...
   /* public Cursor getfeedback(String user_name, String password, String table) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor res = null;
        if (TABLE_NAME_FEEDBACK.equals(table)) {
            res = db.rawQuery("select * from " + TABLE_NAME_FEEDBACK + " where username=? and password=?", new String[]{user_name, password});
