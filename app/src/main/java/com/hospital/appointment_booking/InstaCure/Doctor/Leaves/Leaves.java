    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(Leaves.this, Login.class));
                Message.message(Leaves.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(Leaves.this, Doctor.class));
                Message.message(Leaves.this,"MAIN MENU");
                this.finish();
                return true;
            default:
