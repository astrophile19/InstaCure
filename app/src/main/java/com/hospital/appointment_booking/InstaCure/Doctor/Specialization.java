    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(Specialization.this, Login.class));
                Message.message(Specialization.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(Specialization.this, Doctor.class));
                Message.message(Specialization.this,"MAIN MENU");
                this.finish();
                return true;
            default:
