        ...
        if (y!=null && y.moveToFirst()) {
            while (true) {
                if (y.getString(4).equals("F")) {
                    ...
                    if (z1.moveToNext()) {
                        d_name.add("Dr. "+z1.getString(1) + " "  +"  ( 300/- )");
                    }
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(Bills.this, Login.class));
                Message.message(Bills.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(Bills.this, Patient.class));
                Message.message(Bills.this,"MAIN MENU");
                this.finish();
                return true;
            default:
