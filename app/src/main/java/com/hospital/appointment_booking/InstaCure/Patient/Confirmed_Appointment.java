...
public class Confirmed_Appointment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv_confirmapp= (ListView) findViewById(R.id.lv_confirmedapp);
        u_p = new ArrayList<>();
        p_p = new ArrayList<>();
        ...
        if (y!=null && y.moveToFirst()) {
            ...
            lv_confirmapp.setAdapter(adapter);
        } else {
            Message.message(Confirmed_Appointment.this, "No Pending Apppointments");
            finish();
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(Confirmed_Appointment.this, Login.class));
                Message.message(Confirmed_Appointment.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(Confirmed_Appointment.this, Patient.class));
                Message.message(Confirmed_Appointment.this,"MAIN MENU");
                this.finish();
                return true;
            default:
