            ...
            case R.id.b_refresh:
                ...
                if (y.moveToFirst()) {
                    ...
                    Set<String> set_s = new HashSet<>();
                     Log.e("Inside Y.movefirst","looping");
                    // CHECK SLOT
                    if (y.getString(5).equals("Y")) {

                        hs = y.getString(3);
                        hsi = ((int) hs.charAt(0) - (int) '0') *10 ;
                        //hsi += ((int) hs.charAt(1) - (int) '0')*10  ;

                        he = y.getString(4);
                        hei = ((int) he.charAt(0) - (int) '0') *10 ;
                        //hei += ((int) he.charAt(1) - (int) '0') *10;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(New_Appointment.this, Login.class));
                Message.message(New_Appointment.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(New_Appointment.this, Patient.class));
                Message.message(New_Appointment.this,"MAIN MENU");
                this.finish();
                return true;
            default:
