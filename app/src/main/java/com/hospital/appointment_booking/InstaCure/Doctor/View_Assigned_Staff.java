    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_logout:
                startActivity(new Intent(View_Assigned_Staff.this, Login.class));
                Message.message(View_Assigned_Staff.this,"Logging Out");
                return true;
            case  R.id.menu_mainmenu:
                startActivity(new Intent(View_Assigned_Staff.this, Doctor.class));
                Message.message(View_Assigned_Staff.this,"MAIN MENU");
                this.finish();
                return true;
            default:
